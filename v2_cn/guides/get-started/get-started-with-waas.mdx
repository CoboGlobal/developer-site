...
请确认 Cobo 销售团队已为您开通 Cobo 账户和团队。如需申请，请[联系 Cobo 销售团队](https://www.cobo.com/book-demo/?utm_source=developer-site&utm_medium=product&utm_campaign=contact-sales)。如果要加入现有团队，请让团队管理员邀请您。

<Note>本指南的所有示例均使用开发环境。继续前，请确认销售团队已为您的团队开通开发环境访问权限。</Note>
...
- 要开始使用钱包，您的组织必须开通有效的付费套餐。要了解定价计划、账单与付款的详细信息，请参阅[账单与支付简介](https://manuals.cobo.com/cn/portal/bills-and-payments/introduction)。
