...
- 新增以下 Travel Rule 相关接口：
  - [获取签名挑战](/v2/api-references/travel-rule/get-signature-challenge)
  - [创建 Satoshi Test 挑战](/v2/api-references/travel-rule/create-satoshi-test-challenge)
  - [获取 Satoshi Test 挑战状态](/v2/api-references/travel-rule/get-satoshi-test-challenge-status)
  - [取消 Satoshi Test 挑战](/v2/api-references/travel-rule/cancel-satoshi-test-challenge)
  - [获取地址验证列表](/v2/api-references/travel-rule/list-address-verifications)
...
- 在 [Get transaction information](/v2/api-references/transactions/get-transaction-information) 接口的 `cobo_category` 中新增支持的枚举值 `TrxRecharge`。
