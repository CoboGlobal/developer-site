...
<Note>请使用 `cobo_category` 识别 Fee Station 专属交易类别。这些取值已在 [Cobo-defined categories](/v2_cn/guides/transactions/manage-transactions#cobo-defined-categories) 中说明。</Note>
