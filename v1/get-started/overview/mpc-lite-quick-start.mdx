...
## Account Opening
New accounts cannot be registered directly. To request a WaaS 1.0 account and organization, [contact Cobo Sales](https://www.cobo.com/book-demo/?utm_source=developer-site&utm_medium=product&utm_campaign=contact-sales).
<Warning>
Development environment access is only required if you fall under one of the following categories. Otherwise, use the production environment instead.
