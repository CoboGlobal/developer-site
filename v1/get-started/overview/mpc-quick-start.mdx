...
## Account Opening 
To start using Cobo MPC Custody, you will need to open an account in the development environment by heading to https://home.dev.cobo.com/#/login. Alternatively, you may [contact Cobo](https://www.cobo.com/) to request an invitation email.
