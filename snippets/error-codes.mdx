...
| Error code | Description | Solution |
|---|---|---|
| 2101 | The wallet name exceeds the maximum allowed character length. | The `error_message` states the maximum number of characters allowed for a wallet name. Shorten the wallet name to that limit or fewer, then retry. |
| 2102 | The wallet name contains invalid characters. | Wallet names may contain only letters, numbers, underscores, and Chinese characters. Remove any other characters, such as spaces or punctuation, and retry. |
