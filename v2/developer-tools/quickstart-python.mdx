...
- You have [set up Cobo Accounts](https://manuals.cobo.com/en/accounts/sign-up).
- You have [generated an API key](/developers/v2/api-references/overview/cobo-auth#generate-an-api-key), and [register the API key](https://manuals.cobo.com/en/portal/developer-console/create-api-key) on Cobo Portal.
