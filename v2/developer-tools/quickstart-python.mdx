...
- Follow the instructions in [Get started with WaaS 2.0](https://docs.google.com/document/d/1IRWINESCRODJj9Tp6nub0Oryj2pgxOFZZyjEl4S4s0g/edit#heading=h.mwfqcwnzcexq) to set up your Cobo account, generate an API key, and register your API key on Cobo Portal.
...
For operation-specific documentation and sample code, see [the docs folder](https://github.com/CoboGlobal/cobo-waas2-python-api/tree/master/docs) in the GitHub repository. 
...
from cobo_waas2.models.created_wallet import CreatedWallet
...
configuration = cobo_waas2.Configuration(
    ...
    with cobo_waas2.ApiClient(configuration) as api_client:
        ...
        ​    one_of_schemas={"CreateCustodialWallet"},
