...
- Make sure Cobo Sales has provisioned your Cobo Portal account and organization. To request access, see [Get access to Cobo Portal](https://manuals.cobo.com/en/portal/sign-up). If you are joining an existing organization, ask its admin to invite you.
