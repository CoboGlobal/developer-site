...
`wallet.mpc.balance.updated` and `wallet.web3.balance.updated` use the identical schema and differ only in which wallet type triggered the event (`dev_openapi.yaml:6887-6917`).
