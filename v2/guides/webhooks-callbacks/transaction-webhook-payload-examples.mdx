...
<Note>Use `cobo_category` to identify Fee-Station-specific transaction categories. These values are documented in [Cobo-defined categories](/v2/guides/transactions/manage-transactions#cobo-defined-categories).</Note>
