...
<table class="table-three-cols">
  ...
  <tbody>
    <tr>
      ...
      <td><code>Transaction</code></td>
      <td>A Billing Center transaction has been created.</td>
    </tr>
    <tr>
      <td><code>fee_station.transaction.updated</code></td>
      <td><code>Transaction</code></td>
      <td>There are changes to the status of a Billing Center transaction.</td>
    </tr>
    <tr>
      <td><code>fee_station.transaction.failed</code></td>
      <td><code>Transaction</code></td>
      <td>A Billing Center transaction failed.</td>
    </tr>
    <tr>
      <td><code>fee_station.transaction.succeeded</code></td>
      <td><code>Transaction</code></td>
      <td>A Billing Center transaction has been successfully completed.</td>
    </tr>
  </tbody>
</table>
