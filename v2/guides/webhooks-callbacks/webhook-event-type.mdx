...
<table class="table-three-cols">
  ...
  <tbody>
    <tr>
      ...
      <td><a href="/v2/guides/webhooks-callbacks/transaction-payload-reference"><code>Transaction</code></a></td>
...
For the wallets.transaction.* event family, see [Transaction webhook payload reference](/v2/guides/webhooks-callbacks/transaction-payload-reference) for the full field reference and worked JSON examples.

For a complete introduction to the webhook event data and its data structure across all event types, refer to the [data](/v2/api-references/developers--webhooks/retrieve-event-information#response-data) property in the response of the Retrieve event information operation or the [data.data](/v2/api-references/developers--webhooks/list-all-webhook-events#response-data-data) property in the response of the List all webhook event operation.
