...
- Added the following Travel Rule operations:
  - [Get signature challenge](https://www.cobo.com/developers/v2/api-references/travel-rule/get-signature-challenge)
  - [Create Satoshi Test challenge](https://www.cobo.com/developers/v2/api-references/travel-rule/create-satoshi-test-challenge)
  - [Get Satoshi Test challenge status](https://www.cobo.com/developers/v2/api-references/travel-rule/get-satoshi-test-challenge-status)
  - [Cancel Satoshi Test challenge](https://www.cobo.com/developers/v2/api-references/travel-rule/cancel-satoshi-test-challenge)
  - [List address verifications](https://www.cobo.com/developers/v2/api-references/travel-rule/list-address-verifications)

### Compatibility changes

- Added the `expired_time` field to `user_details` in the response of the [Get transaction approval details](https://www.cobo.com/developers/v2/api-references/transactions/get-transaction-approval-details) operation.
