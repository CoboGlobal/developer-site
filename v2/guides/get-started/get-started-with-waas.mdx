...
Make sure Cobo Sales has provisioned your Cobo account and organization. To request access, [contact Cobo Sales](https://www.cobo.com/book-demo/?utm_source=developer-site&utm_medium=product&utm_campaign=contact-sales). If you are joining an existing organization, ask its admin to invite you.

<Note>This guide uses the development environment in all examples. Make sure Sales has provisioned development environment access for your organization before continuing.</Note>
...
- To start using a wallet, your organization must have an active paid pricing plan. To learn about pricing plans and bills and payments, refer to [Introduction to Bills & Payments](https://manuals.cobo.com/en/portal/bills-and-payments/introduction).
