...
| ContractCall                                      | `Org-Controlled`<br />`User-Controlled`<br />`Web3`                                               | `EVM_Contract`<br />`SOL_Contract`<br />`STELLAR_Contract`<br />`TRON_Contract`<br />`SUI_Contract`             |
...
- `SUI_Contract`: A Sui smart contract.
