...
### Billing Center related

| Category | Description |
|---------|-------------|
| AutoFueling | A transaction where Billing Center pays the gas fee. |
| AutoFuelingRefund | A transaction where Billing Center refunds a previously paid gas fee. |
| BillPayment | A transaction where Billing Center pays Cobo Bills. |
| BillRefund | A transaction where Billing Center refunds previously paid Cobo Bills. |
| GasFeeSponsor | A transaction where Billing Center pays the gas fee using USD stablecoins. |
| GasFeeSponsorRefund | A transaction where Billing Center refunds a gas fee previously paid in USD stablecoins. |
| CommissionFeeCharge | A transaction where Billing Center pays the commission fee. |
| CommissionFeeRefund | A transaction where Billing Center refunds a previously paid commission fee. |

<Note>Billing Center transactions, including their categories, can be retrieved only through [Get Billing Center transaction information](/v2/api-references/feestation/get-fee-station-transaction-information) and [List all Billing Center transactions](/v2/api-references/feestation/list-all-fee-station-transactions).</Note>
