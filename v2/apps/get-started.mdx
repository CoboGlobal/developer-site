...
lang: "en"
description: "Start building a Cobo Portal App with our step-by-step guide. Learn to set up, preview, and publish using Cobo CLI."
---
...
- To build and manage a Cobo Portal App, you need a Cobo account and organization provisioned by Cobo Sales with access to the [development environment](https://portal.dev.cobo.com/). To request access, [contact Cobo Sales](https://www.cobo.com/book-demo/?utm_source=developer-site&utm_medium=product&utm_campaign=contact-sales). If you are joining an existing organization, ask its admin to invite you.
