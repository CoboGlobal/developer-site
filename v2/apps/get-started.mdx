...
- To build and manage a Cobo Portal App, you need a Cobo account and organization provisioned by Cobo Sales with access to the [development environment](https://portal.dev.cobo.com/). To request access, see [Get access to Cobo Portal](https://manuals.cobo.com/en/portal/sign-up). If you are joining an existing organization, ask its admin to invite you.
