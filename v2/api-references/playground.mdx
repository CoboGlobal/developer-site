...
- Make sure Cobo Sales has provisioned your Cobo Account and organization, then create the required API key and API secret. For instructions, see [Access Cobo Accounts](https://manuals.cobo.com/en/accounts/sign-up) and [Generate an API key and an API secret](/v2/guides/overview/cobo-auth#generate-an-api-key-and-an-api-secret).
...
1. Go to any API operation in the API Reference and click **Try it**.  
   ...
   <img src="/v2/images/api-reference/playground-try.png" className="screenshot_full_screen" alt="API Playground try" />
   ...
   <img src="/v2/images/api-reference/playground.png" className="screenshot_full_screen" alt="API Playground panel" />
...
3. Choose the API base URL that you want to send requests to:
   ...
   <img src="/v2/images/api-reference/playground-switch.png" className="screenshot_full_screen" alt="API Playground switch environment" />
